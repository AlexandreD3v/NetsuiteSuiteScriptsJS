...
define(['./cryptojsSS2_i'], function (CryptoJS) {
    /**
     * Constructor
    ...
    function OAuth(opts) {
        ...
        if (!opts.hash_function) {
            opts.hash_function = function (base_string, key) {
                return this.crypto.HmacSHA256(base_string, key).toString(this.crypto.enc.Base64);
            };
        }
    ...
    OAuth.prototype.getQueryParams = function (url) {
    ...
    OAuth.hash_function_sha1 = function (base_string, key) {
        return this.crypto.HmacSHA1(base_string, key).toString(this.crypto.enc.Base64);
    };

    OAuth.hash_function_sha256 = function (base_string, key) {
        return this.crypto.HmacSHA256(base_string, key).toString(this.crypto.enc.Base64);
    };
    ...
    OAuth.prototype.getHeaders = function (options) {
        var data = {};
        ...
        return this.toHeader(this.authorize(requestData, token));
